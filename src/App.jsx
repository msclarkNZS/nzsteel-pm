...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .cf-req { color: #f87171; }
  .cf-help { font-size: 13px; color: var(--cfdim); }
  .cf-ref { font-size: 12px; color: var(--cfaccent); text-decoration: none; }
  .cf-refphoto { max-width: 100%; border-radius: 8px; border: 1px solid var(--cfborder); }
  .cf-inputwrap { margin-top: 2px; }
  .cf-input { width: 100%; background: var(--cfinput); color: var(--cftext); border: 1px solid var(--cfborder); border-radius: 8px; padding: 12px 14px; font-size: 16px; font-family: 'Roboto', sans-serif; outline: none; }
  .cf-input:focus { border-color: var(--cfaccent); }
  .cf-numrow { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
  .cf-numrow .cf-input { flex: 1; min-width: 120px; }
  .cf-unit { color: var(--cfdim); font-size: 14px; }
  .cf-btnrow { display: flex; gap: 8px; }
  .cf-pf { flex: 1; border: 1px solid var(--cfborder); background: var(--cfinput); color: var(--cfdim); border-radius: 8px; padding: 14px; font-family: 'Roboto Condensed', sans-serif; font-weight: 700; font-size: 16px; text-transform: uppercase; letter-spacing: 1px; cursor: pointer; min-height: 52px; }
  ...
  .cf-toggle { border: 1px solid var(--cfborder); background: var(--cfinput); color: var(--cfdim); border-radius: 8px; padding: 12px 18px; font-weight: 700; cursor: pointer; min-height: 48px; }
  ...
  .cf-matrix-row:first-child { border-top: none; }
